...
namespace GameStoreWeb.Migrations
{
    ...
    [Migration("20260515131725_InitPayments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStoreWeb.Models.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 5, 15, 13, 17, 22, 652, DateTimeKind.Utc).AddTicks(7775),
                            ...
                            UpdatedAt = new DateTime(2026, 5, 15, 13, 17, 22, 652, DateTimeKind.Utc).AddTicks(7775)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("GameStoreWeb.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameStoreWeb.Models.Payment", b =>
                {
                    b.HasOne("GameStoreWeb.Models.Order", null)
                        .WithMany("Payments")
